...
class City_model extends MY_Model {
    ...
    function __construct(){
        ...
        $this->table_title = "City";
    }
    
    public function get_records($country_id,$state_id,$post_data=array(),$pagination = true,$page_no=1 ) {
        //Get Restaurant List
        $record_sql = $this->db->select('*')
                ->from($this->table_name)
                ->where( array("is_deleted"=>NOT_DELETED,"state_id"=>$state_id,"country_id"=>$country_id) );
