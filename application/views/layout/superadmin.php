...
<html lang="en">
    ...
    <head><base href=""/>
        ...
        <link rel="shortcut icon" href="<?php echo base_url(BASE_ASSETS_PATH.SUPERADMIN . "/images/favicon.ico") ?>" />
        <!--begin::Fonts(mandatory for all pages)-->
        <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Inter:300,400,500,600,700" />
        <!--end::Fonts-->
        <!--begin::Vendor Stylesheets(used for this page only)-->
        <link href="<?php echo base_url(BASE_ASSETS_PATH.SUPERADMIN. "/plugins/custom/fullcalendar/fullcalendar.bundle.css") ?>" rel="stylesheet" type="text/css" />
        <link href="<?php echo base_url(BASE_ASSETS_PATH .SUPERADMIN. "/plugins/custom/datatables/datatables.bundle.css") ?>" rel="stylesheet" type="text/css" />
        ...
        <script src="<?php echo base_url(BASE_ASSETS_PATH .SUPERADMIN. "/plugins/custom/datatables/datatables.bundle.js") ?>"></script>
        <!--end::Vendors Javascript-->
        <!--begin::Custom Javascript(used for this page only)-->
        <script src="<?php echo base_url(BASE_ASSETS_PATH .SUPERADMIN. "/js/widgets.bundle.js") ?>"></script>
        <script src="<?php echo base_url(BASE_SUPERADMIN_JS_PATH . "custom/widgets.js") ?>"></script>
        <script src="<?php echo base_url(BASE_SUPERADMIN_JS_PATH . "main.js") ?>"></script>
        <!--end::Javascript-->
        <style type="text/css">
            .loader_div {height: 100%;width: 100%;overflow: hidden;background-color: rgb(255,255,255,.5);
    text-align: center;display: flex;z-index: 99999;position: fixed;}
    .loader_div img {margin: auto;}
        </style>
    ...
    <body id="kt_app_body" data-kt-app-header-fixed="true" data-kt-app-header-fixed-mobile="true" data-kt-app-sidebar-enabled="true" data-kt-app-sidebar-fixed="true" data-kt-app-sidebar-push-header="true" data-kt-app-sidebar-push-toolbar="true" data-kt-app-sidebar-push-footer="true" class="app-default">
                ...
                <div id="kt_app_header" class="app-header">
                    ...
                    <div class="app-container container-fluid d-flex align-items-stretch flex-stack" id="kt_app_header_container">
                        ...
                        <div class="d-flex align-items-center d-block d-lg-none ms-n3" title="Show sidebar menu">
                            ...
                            <!--begin::Logo image-->
                            <a href="<?php echo superadmin_url() ?>">
                                <img alt="Logo" src="<?php echo base_url(BASE_ASSETS_PATH.SUPERADMIN . "/images/logo/class-hud-logo.svg") ?>" class="h-30px" />
                            </a>
                            <!--end::Logo image-->
                        </div>
                        <!--end::Sidebar toggle-->
                                                ...
                                                <div class="scroll-y mh-200px mh-lg-350px">
                                                    ...
                                                    <a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
                                                        ...
                                                        <div class="symbol symbol-40px me-4">
                                                            <img src="<?php echo base_url(BASE_ASSETS_PATH . "media/avatars/300-6.jpg") ?>" alt="" />
                                                        </div>
                                                        <!--end::Symbol-->
                                                        <!--begin::Title-->
                                                    ...
                                                    <a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
                                                        <!--begin::Symbol-->
                                                        <div class="symbol symbol-40px me-4">
                                                            <img src="<?php echo base_url(BASE_ASSETS_PATH . "media/avatars/300-2.jpg") ?>" alt="" />
                                                        </div>
                                                        <!--end::Symbol-->
                                                        <!--begin::Title-->
                                                        <div class="d-flex flex-column justify-content-start fw-semibold">
                                                    ...
                                                    <a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
                                                        <!--begin::Symbol-->
                                                        <div class="symbol symbol-40px me-4">
                                                            <img src="<?php echo base_url(BASE_ASSETS_PATH . "media/avatars/300-9.jpg") ?>" alt="" />
                                                        </div>
                                                        <!--end::Symbol-->
                                                        <!--begin::Title-->
                                                        <div class="d-flex flex-column justify-content-start fw-semibold">
                                                    ...
                                                    <a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
                                                        <!--begin::Symbol-->
                                                        <div class="symbol symbol-40px me-4">
                                                            <img src="<?php echo base_url(BASE_ASSETS_PATH . "media/avatars/300-14.jpg") ?>" alt="" />
                                                        </div>
                                                        <!--end::Symbol-->
                                                        <!--begin::Title-->
                                                        <div class="d-flex flex-column justify-content-start fw-semibold">
                                                    ...
                                                    <a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
                                                        <!--begin::Symbol-->
                                                        <div class="symbol symbol-40px me-4">
                                                            <img src="<?php echo base_url(BASE_ASSETS_PATH."media/avatars/300-11.jpg"); ?>" alt="" />
                                                        </div>
                                                        <!--end::Symbol-->
                                                        <!--begin::Title-->
                                                        <div class="d-flex flex-column justify-content-start fw-semibold">
                                                    ...
                                                    <a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
                                                        ...
                                                        <div class="symbol symbol-40px me-4">
                                                            <span class="symbol-label bg-light">
                                                                <img class="w-20px h-20px" src="<?php echo base_url(BASE_ASSETS_PATH."media/svg/brand-logos/volicity-9.svg");?>" alt="" />
                                                            </span>
                                                        </div>
                                                        <!--end::Symbol-->
                                                        <!--begin::Title-->
                                                    ...
                                                    <a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
                                                        ...
                                                        <div class="symbol symbol-40px me-4">
                                                            <span class="symbol-label bg-light">
                                                                <img class="w-20px h-20px" src="<?php echo base_url(BASE_ASSETS_PATH."media/svg/brand-logos/tvit.svg");?>" alt="" />
                                                            </span>
                                                        </div>
                                                        <!--end::Symbol-->
                                                        <!--begin::Title-->
                                                    ...
                                                    <a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
                                                        ...
                                                        <div class="symbol symbol-40px me-4">
                                                            <span class="symbol-label bg-light">
                                                                <img class="w-20px h-20px" src="<?php echo base_url(BASE_ASSETS_PATH."media/svg/misc/infography.svg"); ?>" alt="" />
                                                            </span>
                                                        </div>
                                                        <!--end::Symbol-->
                                                        <!--begin::Title-->
                                                    ...
                                                    <a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
                                                        ...
                                                        <div class="symbol symbol-40px me-4">
                                                            <span class="symbol-label bg-light">
                                                                <img class="w-20px h-20px" src="<?php echo base_url(BASE_ASSETS_PATH."media/svg/brand-logos/leaf.svg");?>" alt="" />
                                                            </span>
                                                        </div>
                                                        <!--end::Symbol-->
                                                        <!--begin::Title-->
                                                    ...
                                                    <a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
                                                        ...
                                                        <div class="symbol symbol-40px me-4">
                                                            <span class="symbol-label bg-light">
                                                                <img class="w-20px h-20px" src="<?php echo base_url(BASE_ASSETS_PATH."media/svg/brand-logos/tower.svg"); ?>" alt="" />
                                                            </span>
                                                        </div>
                                                        <!--end::Symbol-->
                                                        <!--begin::Title-->
                                        ...
                                        <div class="tab-pane fade show active" id="kt_topbar_notifications_2" role="tabpanel">
                                            ...
                                            <div class="d-flex flex-column px-9">
                                                ...
                                                <div class="text-center px-4">
                                                    <img class="mw-100 mh-200px" alt="image" src="<?php echo base_url(BASE_ASSETS_PATH."media/illustrations/sketchy-1/1.png"); ?>" />
                                                </div>
                                                <!--end::Illustration-->
                                            </div>
                                            <!--end::Wrapper-->
                ...
                <div class="app-wrapper flex-column flex-row-fluid" id="kt_app_wrapper">
                    ...
                    <div id="kt_app_sidebar" class="app-sidebar flex-column" data-kt-drawer="true" data-kt-drawer-name="app-sidebar" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="250px" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_app_sidebar_mobile_toggle">
                        <div class="app-sidebar-logo flex-shrink-0 d-none d-md-flex align-items-center px-8" id="kt_app_sidebar_logo">
                            <!--begin::Logo-->
                            <a href="<?php echo superadmin_url() ?>">
                                <img alt="Logo" src="<?php echo base_url(BASE_ASSETS_PATH.SUPERADMIN . "/images/logo/class-hud-logo.svg") ?>" class="h-25px d-none d-sm-inline app-sidebar-logo-default theme-light-show" />
                                <img alt="Logo" src="<?php echo base_url(BASE_ASSETS_PATH.SUPERADMIN . "/images/logo/class-hud-logo.svg") ?>" class="h-25px h-lg-25px theme-dark-show" />
                            </a>
                            <!--end::Logo-->
                            <!--begin::Aside toggle-->
                        ...
                        <div class="app-sidebar-menu overflow-hidden flex-column-fluid">
                            ...
                            <div id="kt_app_sidebar_menu_wrapper" class="app-sidebar-wrapper hover-scroll-overlay-y my-5" data-kt-scroll="true" data-kt-scroll-activate="true" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_app_sidebar_logo, #kt_app_sidebar_footer" data-kt-scroll-wrappers="#kt_app_sidebar_menu" data-kt-scroll-offset="5px">
                                <div class="menu menu-column menu-rounded menu-sub-indention fw-semibold px-3" id="#kt_app_sidebar_menu" data-kt-menu="true" data-kt-menu-expand="false">
                                    ...
                                    <!--begin::Menu-->
                                    <?php
                                    $menus = get_all_permissions()[SUPERADMIN];
                                    $menu_html = "";
                                    foreach ($menus as $menu_id => $menu_detail) {
                                        $sub_html = "";
                                        $active_child = $show_menu = 0;
                                        if (count($menu_detail['operations']) > 0 && $menu_detail['show_in_menu'] == MENU_SHOW) {
                                            foreach ($menu_detail['operations'] as $key => $operation_detail) {
                                                if (hasPermission($this->user_data['group_id'], $operation_detail['slug'], SUPERADMIN) && $operation_detail['show_in_menu'] == MENU_SHOW) {
                                                    $show_menu = 1;
                                                    $url_modules = $this->uri->segment(2);
                                                    $url = str_replace(".", "/", $operation_detail['slug']);
                                                    $operation_slug_arr = explode('/', $url);

                                                    $active_class = "";
                                                    if ($operation_detail['slug'] == $this->action_name) {
                                                        $active_child = 1;
                                                        $active_class = "active";
                                                    } elseif ( $url_modules == $operation_slug_arr[0] ) {
                                                        $active_child = 1;
                                                        $active_class = "active";
                                                    }
                                                    $url = superadmin_url($url);
                                                    $sub_html.="<div class='menu-item'>
                                                                    <!--begin:Menu link-->
                                                                    <a class='menu-link {$active_class}' href='{$url}'>
                                                                        <span class='menu-bullet'>
                                                                            <span class='bullet bullet-dot'></span>
                                                                        </span>
                                                                        <span class='menu-title'>{$operation_detail['display_name']}</span>
                                                                    </a>
                                                                    <!--end:Menu link-->
                                                                </div>";
                                                }
                                            ...
                                            if ($show_menu == 0) {
                                                ...
                                                $menu_html.="<div data-kt-menu-trigger='click' class='menu-item menu-accordion " . (!empty($active_child) ? "show" : "") . "'>
                                                                <span class='menu-link'>
                                                                    <span class='menu-icon'>
                                                                        <i class='{$menu_detail['icon_class']} fs-3'></i>
                                                                    </span>
                                                                    <span class='menu-title'>{$menu_detail['display_name']}</span>
                                                                    <span class='menu-arrow'></span>
                                                                </span>
                                                                <div class='menu-sub menu-sub-accordion'>{$sub_html}</div>
                                                            </div>
                                                            ";
                                            }
                                        } else {
                            ...
                            <div class="">
                                ...
                                <div class="d-flex align-items-center" data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-overflow="true" data-kt-menu-placement="top-start">
                                    ...
                                    <div class="d-flex flex-column align-items-start justify-content-center ms-3">
                                        <span class="text-gray-500 fs-8 fw-semibold"><?php echo $this->lang->line("heading_hello") ?></span>
                                        <a href="#" class="text-gray-800 fs-7 fw-bold text-hover-primary"><?php echo "{$this->user_data['full_name']}" ?></a>
                                    </div>
                                    <!--end::Name-->
                                </div>
                                <!--end::User info-->
                                ...
                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px" data-kt-menu="true">
                                    ...
                                    <div class="menu-item px-3">
                                        <div class="menu-content d-flex align-items-center px-3">
                                            ...
                                            <div class="symbol symbol-50px me-5">
                                                <img alt="<?php echo "{$this->user_data['full_name']}" ?>" src="<?php echo $this->user_data['image'] ?>" />
                                            </div>
                                            <!--end::Avatar-->
                                            <!--begin::Username-->
                                            <div class="d-flex flex-column">
                                                <a href="#" class="fw-semibold text-muted text-hover-primary fs-7"><?php echo $this->user_data['email'] ?></a>
                                            </div>
                                            <!--end::Username-->
                                        </div>
                                    </div>
                                    ...
                                    <div class="menu-item px-5" data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="right-end" data-kt-menu-offset="-15px, 0">
                                        ...
                                        <div class="menu-sub menu-sub-dropdown w-175px py-4">
                                            <!--begin::Menu item-->
                                            <div class="menu-item px-3">
                                                <a href="<?php echo superadmin_url("users/edit_profile") ?>" class="menu-link px-5"><?php echo $this->lang->line("heading_edit_profile"); ?></a>
                                            </div>
                                            <!--end::Menu item-->
                                            <!--begin::Menu item-->
                                            <div class="menu-item px-3">
                                                <a href="<?php echo superadmin_url("users/change_password") ?>" class="menu-link px-5"><?php echo $this->lang->line("heading_change_password"); ?></a>
                                            </div>
                                            <!--end::Menu item-->
                                            <!--begin::Menu item-->
                                            <div class="menu-item px-3">
                                                <a href="<?php echo superadmin_url("users/logout") ?>" class="menu-link px-5"><?php echo $this->lang->line("heading_signout"); ?></a>
                                            </div>
                                            <!--end::Menu item-->
        ...
        <div class="modal fade" id="kt_modal_alert" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <!--begin::Modal dialog-->
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body pt-0">
                        <div class="swal2-icon swal2-warning swal2-icon-show d-flex mt-0">
                            <div class="swal2-icon-content">!</div>
                        </div>
                        <div class="swal2-html-container" id="alert_model_message"></div>

                        <div class="swal2-actions d-flex">
                            <a type="button" class="swal2-confirm btn fw-bold btn-danger" href="#" aria-label=""><?php echo $this->lang->line('heading_ok') ?></a>
                            <button type="button" class="swal2-cancel btn fw-bold btn-active-light-primary" data-bs-dismiss="modal"><?php echo $this->lang->line('heading_cancel') ?></button>
                        </div>
                    </div>
                    <!--end::Modal body-->
                </div>
        ...
        <script type="text/javascript">
            $(function () {
                $("#kt_modal_alert").on("show.bs.modal", function (e) {
                    var $modal = $(this);
                    var $opener = $(e.relatedTarget);
                    var $title = $opener.data("title");
                    var $link = $opener.data("href");
                    $modal.find(".swal2-confirm").attr("href", $link);
                    $modal.find("#alert_model_message").text($title);
                });
                $("#kt_datatable").DataTable();
            });
        </script>
        <script src="<?php echo base_url(BASE_ASSETS_PATH.SUPERADMIN."/plugins/custom/fslightbox/fslightbox.bundle.js") ?>"></script>
        <!--end::Modals-->
