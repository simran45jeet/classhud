   ...
   <tbody>
       <tr>
           <td style="width: 95%; display: block; margin: auto">      
                <h1 style="font-size: 24px; line-height:32px;text-align:center;color:#000; font-family: \'Montserrat\', sans-serif!important; ">'.$lang_arr['bk_confirm_pending'].'</h1>          
               <p style="'.$paraCSS.'">'.$lang_arr['thanks'].' '.$email_data['contact_name'].',<br/><br/>'.$lang_arr['bk_request_message'].'</p>
           </td>
       </tr>
       <tr>
            <th style="'.$paraCSS.' width:95%;display:block;margin:auto;text-align: center">                
            <br/>'.$lang_arr['your_request_detail'].':
            </th>
        </tr>
