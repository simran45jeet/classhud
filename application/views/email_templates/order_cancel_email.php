   ...
   <td>
    <table style="font-size: 14px; font-weight: normal;color:#000;line-height: 22px;font-family: \'Montserrat\', sans-serif!important; " width="100%">
        <tr>
            ...
            <h1 style="line-height:32px; font-size: 24px; text-align:center;color:#000; font-family: \'Montserrat\', sans-serif!important; ">Order has been cancelled.</h1>             
                <p style="'.$paraCSS.'">
                    Dear '.$user_name.',<br/><br/>
                    Sorry , Your Order '.$invoice_id.' is Cancelled. Reason is as below :<br/><br/>
                    '.$reason.'
                </p>  
            </td>
        </tr>
