          ...
          <table class="inner_table" width="345" cellpadding="0" cellspacing="0"  style="width:345px;margin:0 auto;" align="center" >
            ...
            <tr>
              <td style="color:#fff;text-align:center;">
                <h2 style="margin-top: 0px;margin-bottom: 0px;padding: 12px 0px;font-weight: 700;font-size:22px;color: #e5e5e5;">You Refund <?php //echo count($email_data['gift_cards']); ?> Gift Card</h2>
              </td>
            </tr>
            </table>
