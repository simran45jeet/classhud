        ...
        <tr>
            ...
            <h1 style="font-size: 24px; text-align:center;color:#000; font-family: \'Montserrat\', sans-serif!important; ">Welcome ON BOARD!</h1>             
                <p style="'.$paraCSS.'">
                    ...
                    Welcome to Y The Wait Community! <br/><br/>
                    You are one step away from activating your account. Please use the verification code to activate your account. 
                </p>  
            </td>
        </tr>
        <tr>
            <td style="width:95%;display:block;margin:auto;">      
                <p style="'.$paraCSS.'text-align:center">Verification code</p>
                ...
                <p style="'.$paraCSS.'">Simply, enter it into the account verification input field.</p>
                <p style="'.$paraCSS.'">Thanks for helping us activate your Y the Wait community account.</p>
