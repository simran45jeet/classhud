   ...
   <tbody>
       <tr>
           <td style="width: 95%; display: block; margin: auto">      
                <h1 style="width:100%;font-size: 24px; line-height:32px;text-align:center;color:#000; font-family: \'Montserrat\', sans-serif!important; ">'.$lang_arr['bk_confirmed'].'</h1>          
               <p style="'.$paraCSS.'">'.$lang_arr['dear'].' '.$email_data['contact_name'].',<br/><br/>'.$lang_arr['bk_excited_message'].'</p>
           </td>
       </tr>
       <tr>
            <th style="'.$paraCSS.' width:95%;display:block;margin:auto;text-align: center">                         
            <br/>'.$lang_arr['bk_find_details'].'
            </th>
        </tr>
           ...
           <td style="'.$paraCSS.' width:95%;display:block;margin:auto;">
               <table>
                   <tbody>
                        ...
                        <tr>
                            <td style="font-size:13px;line-height:18px">
                                '.$lang_arr['bk_id'].':<b>'.$email_data['unique_id'].'</b><i> '.$lang_arr['restaurant_ref'].'</i>   
                            </td>
                        </tr>
                        <tr>
                            <td style="font-size:13px;line-height:18px">
