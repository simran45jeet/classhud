   ...
   <td>
      <table width="100%" style="font-family: \'Montserrat\', sans-serif !important;">
        <tr>
            ...
            <h1 style="width:100%;font-size: 24px; line-height:32px;text-align:center;color:#000; font-family: \'Montserrat\', sans-serif !important; ">New business listing requrest.</h1>  
                <p style="'.$paraCSS .'">Dear '.ucwords($email_data["user_first_name"].' '.$email_data["user_last_name"]).',<br/><br/> You have recieved a new business listing request, details are as below:<br/><br/></p>          
            </td>
        </tr>
        <tr>
