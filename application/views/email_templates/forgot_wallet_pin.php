   ...
   <td>
      <table width="100%" style="font-family: \'Montserrat\', sans-serif !important;">
        <tr>
            ...
            <h1 style="width:100%;font-size: 24px; line-height:32px;text-align:center;color:#000; font-family: \'Montserrat\', sans-serif !important; ">Recover Wallet Pin</h1>  
                <p style="'.$paraCSS .'">Dear '.$email_data["name"].',<br/><br/>We have received a request to reset waller pin for your YTheWait account. Please follow the link below for resetting your pin::<br/><br/></p>          
            </td>
        </tr>
        <tr>
