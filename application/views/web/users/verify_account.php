...
function timer(remaining) {
 ...
 // alert('Timeout for otp');
  ...
  $("#resend").html('<a href="<?php echo base_url("{$controller_name}/resend_verify_code/{$edited_id}") ?>" style="float:right; color:#E12829;" /><?php echo $this->lang->line("heading_resend") ?></a>');
