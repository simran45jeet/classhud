                ...
                <div class="listing-action clearfix">
                    ...
                    <div class="action-right">
                        <div class="job-dashboard-actions"> 
                            ...
                            $share_phone = !empty($listing_data["primary_whatsapp_no"]) ? str_replace("+","",$listing_data["primary_whatsapp_code_name"]).$listing_data["primary_whatsapp_no"] : str_replace("+","",$listing_data["primary_phone_code_name"]).$listing_data["primary_phone_no"];
                            ?>
                            <a class="btn-gray-icon job-dashboard-action-delete" href="https://api.whatsapp.com/send?text=<?php echo urlencode(sprintf( $this->lang->line("heading_ecard_wa_share_message"),$listing_data["name"],base_url("ecard/{$listing_data["slug"]}") )) ?>&phone=<?php echo $share_phone ?>">
                                
                                <i class="fa fa-whatsapp m-0"></i> 
                            </a>
                            <a href="<?php echo base_url("{$controller_name}/download_ecard/{$listing_data["id"]}") ?>" class="btn-gray-icon job-dashboard-action-delete"><i class="fa fa-download m-0"></i></a>
                        </div>
                    </div>
                </div>
            </div>
