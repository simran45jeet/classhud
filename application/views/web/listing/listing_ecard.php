...
<!--        <script src="https://cdnjs.cloudflare.com/ajax/libs/html2canvas/0.4.1/html2canvas.js"></script>
        ...
        <script type="text/javascript">
            ...
            function initialize_map() {
                ...
                var macc = {lat: <?php echo $record["latitude"] ?>, lng: <?php echo $record["longitude"] ?>};
                var map = new google.maps.Map(document.getElementById('lt-listing--map'), {zoom: 15, center: macc});

                var latlng = new google.maps.LatLng(<?php echo $record["latitude"] ?>, <?php echo $record["longitude"] ?>);
        ...
        <main id="main">
            <section class="top-card">
                ...
                <div class="buttontop">
                    ...
                    &nbsp;&nbsp;
                    <a href="https://www.google.com/maps/search/<?php echo "{$record["latitude"]},{$record["longitude"]}" ?>" class="openmaps" target="_blank">
                        <i class="fa-solid fa-location-dot" style="color: #ffffff;"></i>&nbsp;&nbsp; OPEN MAPS
                    </a>
            ...
            <div class="cardmap">
                <h4 class="directions">Get Directions</h4>
                <div  class="cardimage" id="lt-listing--map"></div>
            </div>
