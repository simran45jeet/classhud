                ...
                <div class="listing-action clearfix">
                    ...
                    <div class="action-right">
                        <div class="job-dashboard-actions"> 
                            <a href="<?php echo $edit_link ?>" class="btn-gray-icon job-dashboard-action-continue">
                                <?php 
                                if( $listing_data["request_status"]==LISTING_REQUEST_STATUS_DISAPPROVED ) {
                                    $edit_text_lang = "heading_listing_continue_submission";
                                }else if( $listing_data["request_status"]==LISTING_REQUEST_STATUS_APPROVED ) {
                                    $edit_text_lang = "heading_listing_edit_my_listing";
                                }else{   
                                    $edit_text_lang = "heading_listing_wait_response";
                                }
                                echo $this->lang->line($edit_text_lang);
                                ?>
                            </a>
