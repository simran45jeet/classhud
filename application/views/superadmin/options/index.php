<?php 
$option_values_permission = hasPermission($this->user_data['group_id'],"option_values.index",SUPERADMIN);
$edit_permissions = hasPermission($this->user_data['group_id'],"{$controller_name}.edit",SUPERADMIN);
?>
<div class="d-flex justify-content-end pb-5" data-kt-customer-table-toolbar="base">
    <div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
        ...
        <div class="d-flex align-items-center gap-2 gap-lg-3">
            ...
            <!--begin::Add customer-->
            <a type="button" class="btn btn-primary" href="<?php echo superadmin_url("{$controller_name}/add/{$option_id}") ?>"><?php echo $this->lang->line("heading_add_option") ?></a>
            <?php } ?>
        </div>
        <!--end::Add customer-->
    </div>
...
<div class="card">
    ...
    <div class="card-body pt-0">
        <!--begin::Table-->
        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_records_table">
            <!--begin::Table head-->
            <thead>
                <!--begin::Table row-->
                <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                    ...
                    <th class="min-w-125px"><?php echo $this->lang->line("heading_option_name") ?></th>
                    <th class="min-w-125px"><?php echo $this->lang->line("heading_option_for_type") ?></th>
                    <th class="min-w-125px"><?php echo $this->lang->line("heading_created_date") ?></th>
            ...
            <tbody class="fw-semibold text-gray-600">                
                ...
                <tr>
                    ...
                    <td>
                        <a href="<?php echo superadmin_url("{$controller_name}/edit/".encrypt($record['id'])) ?>" class="text-gray-800 text-hover-primary mb-1"><?php echo $record["name"] ?></a>
                    </td>
                    <!--end::Name=-->
                    <!--begin::Email=-->
                    <td><?php echo $display_types[$record["display_type"]] ?></td>
                    <!--end::Email=-->
                    <!--begin::Date=-->
                    <td><?php echo date(DEFAULT_DATETIME_FORMAT,strtotime($record['created_at'])) ?></td>
                    <!--end::Date=-->
                    <!--begin::Action=-->
                    <td class="text-end">
                        ...
                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                            ...
                            <!--end::Menu item-->
                            <?php } 
                            if($option_values_permission) {?>
                            <!--begin::Menu item-->
                            <div class="menu-item px-3">
                                <a href="<?php echo superadmin_url("option_values/index/{$encoded_id}") ?>" class="menu-link px-3"><?php echo $this->lang->line("heading_option_values"); ?></a>
                            </div>
                            <!--end::Menu item-->
                            <?php } ?>
