                ...
                <div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px" data-kt-menu="true" id="kt-toolbar-filter-verify-type">
                    ...
                    <div class="px-7 py-5">
                        ...
                        <div class="mb-10">
                            ...
                            <!--end::Label-->
                            <!--begin::Input-->
                            <select class="form-select form-select-solid fw-bold" data-kt-select2="true" data-placeholder="Select option" data-allow-clear="true" data-kt-customer-table-filter="month" data-dropdown-parent="#kt-toolbar-filter-verify-type" name="request_status">
                                <option value="-1"><?php echo $this->lang->line("heading_all_records_title") ?></option>
                                <option value="<?php echo REVIEW_STATUS_PENDING ?>" <?php echo ( isset($post_data["request_status"]) &&  is_numeric($post_data["request_status"]) && $post_data["request_status"]==REVIEW_STATUS_PENDING ) ? "selected=''" :"" ?>><?php echo $this->lang->line("heading_listing_review_request_status_title") ?></option>
                            <option value="<?php echo REVIEW_STATUS_APPROVE ?>" <?php echo !empty($post_data["request_status"]) && $post_data["request_status"]==REVIEW_STATUS_APPROVE ? "selected=''" :"" ?>><?php echo $this->lang->line("heading_listing_review_approved_status_title") ?></option>
                            <option value="<?php echo REVIEW_STATUS_DISAPPROVE ?>" <?php echo !empty($post_data["request_status"]) &&  $post_data["request_status"]==REVIEW_STATUS_DISAPPROVE ? "selected=''" :"" ?>><?php echo $this->lang->line("heading_listing_review_disapproved_status_title") ?></option>
        ...
        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_staff_table">
            ...
            <thead>
                ...
                <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                    ...
                    <th class="min-w-125px"><?php echo $this->lang->line("heading_rating_title") ?></th>
                    <th class="min-w-125px"><?php echo $this->lang->line("heading_listing_review_request_title") ?></th>
            ...
            <tbody class="fw-semibold text-gray-600">                
                ...
                foreach( $records as $key=>$record ) {
                    ...
                    $encoded_listing_id = encrypt($record['listing_id'])
                ?>
                <tr>
                    <!--begin::Name=-->
                    ...
                    <td>
                        <div class="d-flex align-items-center">
                            <!--begin::Thumbnail-->
                            <a href="<?php echo $edit_listing_permission ? superadmin_url("listing/edit/{$encoded_listing_id}") : "#"; ?>" class="symbol symbol-50px">
                                <span class="symbol-label" style="background-image:url('<?php echo base_url(BASE_LISTING_COVER_IMAGE_PATH."{$record["cover_image"]}") ?>');"></span>
                            </a>
                            <!--end::Thumbnail-->
                            <div class="ms-5">
                                <!--begin::Title-->
                                <a href="<?php echo $edit_permission ? superadmin_url("listing/edit/{$encoded_listing_id}") : "#"; ?>" class="text-gray-800 text-hover-primary fs-5 fw-bold" data-kt-ecommerce-product-filter="listing_name"><?php echo $record["listing_name"] ?></a>
                                <!--end::Title-->
                            </div>
                        </div>
                    ...
                    <td>
                        <?php 
                        if( $record['request_status'] == REVIEW_STATUS_PENDING) {
                            echo $this->lang->line("heading_listing_review_request_status_title");
                        }elseif( $record['request_status'] == REVIEW_STATUS_APPROVE) {
                            echo $this->lang->line("heading_listing_review_approved_status_title");
                        }elseif( $record['request_status'] == REVIEW_STATUS_DISAPPROVE) {
                            echo $this->lang->line("heading_listing_review_disapproved_status_title");
                        }
                        ?>
                    </td>
                    <td class="text-end">
