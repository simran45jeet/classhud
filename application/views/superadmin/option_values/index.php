...
<div class="d-flex justify-content-end pb-5" data-kt-customer-table-toolbar="base">
    <div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
        ...
        <div class="d-flex align-items-center gap-2 gap-lg-3">
            ...
            <!--begin::Add customer-->
            <a type="button" class="btn btn-primary" href="<?php echo superadmin_url("{$controller_name}/add/{$option_id}") ?>"><?php echo $this->lang->line("heading_add_option_value") ?></a>
            <?php } ?>
        </div>
        <!--end::Add customer-->
    </div>
    ...
    <div class="card-body pt-0">
        ...
        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_records_table">
            ...
            <tbody class="fw-semibold text-gray-600">                
                        ...
                        <td class="text-end">
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                                ...
                                <div class="menu-item px-3">
                                    <a href="<?php echo superadmin_url("{$controller_name}/edit/{$option_id}/{$encoded_id}") ?>" class="menu-link px-3"><?php echo $this->lang->line("heading_edit") ?></a>
                                </div>
                                <!--end::Menu item-->
                                <?php } ?>
                ...
                ?>
                <tr class="odd text-center"><td colspan="5" class="dataTables_empty" valign="top"><?php echo $this->lang->line("message_no_records") ?></td></tr>
                <?php } ?>
            </tbody>
            <!--end::Table body-->
        </table>
