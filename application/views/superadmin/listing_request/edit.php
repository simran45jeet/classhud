                            ...
                            <div class="card-body pt-0 pb-5">
                                <div class="row mb-5">                                    
                                    ...
                                    <div class="col-md-6 fv-row">
                                        ...
                                        <input type="name" class="form-control form-control-solid" placeholder="<?php echo $this->lang->line("heading_name") ?>" name="name" value="<?php echo $post_data["name"]? : ""; ?>" />
                                    </div>
                                </div>
                                <div class="row mb-5">                                    
                                    <div class="col-md-6 fv-row">
                                            ...
                                            <div class="row">
                                                <div class="col-md-10 col-sm-10">
                                                    <div class="row">
                                                        ...
                                                        <div class="<?php echo count($phone_codes) == 1 ? "col-md-12" : "col-md-9" ?>">
                                                            <input type="text" class="form-control form-control-solid" placeholder="<?php echo $this->lang->line("heading_phone") ?>" name="listing_phone[]" value="<?php echo $phone_no ?>"/>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-2 col-sm-2">
                                ...
                                <div class="row mb-5">
                                    ...
                                    <div class="col-md-6 fv-row">
                                         ...
                                         <div class="form-check form-switch form-check-custom form-check-solid">
                                            <select name="amenities[]" data-control="select2" data-placeholder="<?php echo $this->lang->line('heading_listing_amenity') ?>" class="form-select form-select-solid" multiple="">
                                    ...
                                    <div class="col-md-6 fv-row">
                                        ...
                                        <div class="form-check form-switch form-check-custom form-check-solid">
                                            <select name="request_status" class="form-select form-select-solid" data-control="select2">
                                                <option value="<?php echo LISTING_REQUEST_STATUS_REQUESTED ?>"><?php echo $this->lang->line("heading_listing_request_status")[LISTING_REQUEST_STATUS_REQUESTED] ?></option>
                                                <option value="<?php echo LISTING_REQUEST_STATUS_APPROVED ?>"><?php echo $this->lang->line("heading_listing_request_status")[LISTING_REQUEST_STATUS_APPROVED] ?></option>
                                                <option value="<?php echo LISTING_REQUEST_STATUS_DISAPPROVED ?>"><?php echo $this->lang->line("heading_listing_request_status")[LISTING_REQUEST_STATUS_DISAPPROVED] ?></option>
                                            </select>
                        ...
                        <div class="card pt-4 mb-6 mb-xl-9">
                            ...
                            <div class="card-body pt-0 pb-5" id="listing_social_media">
                                <div class="form-group">
                                    ...
                                    <?php foreach( $post_data["social_media"] as $key=>$listing_social_media ) {?>
                            ...
                            <div class="form-group card-body">
                                ...
                                <div class="form-group row mb-5 timming_row_<?php echo $day_no ?>">
                                    ...
                                    <div class="timing-listing-form col-md-10 col-sm-9 <?php echo ( !empty($post_data['timming']) && array_key_exists($day_no, $post_data['timming']) )?"":"d-none"; ?>">
                                        ...
                                        <?php if( !empty($post_data["timming"][$day_no]) && count($post_data["timming"][$day_no]) >1 ) { 
        ...
        var $html = '<div class="col-md-6 fv-row mt-5">' +
                        ...
                        '<div class="row">' +
                            '<div class="col-md-10 col-sm-10">' +
                                ...
                                '</div>' +
                                '<div class="<?php echo count($phone_codes) == 1 ? "col-md-12" : "col-md-9" ?>">' +
                                    '<input type="text" class="form-control form-control-solid" placeholder="<?php echo $this->lang->line("heading_phone") ?>" name="listing_phone[]" value="<?php echo $listing_phone["phone_no"] ?>"/>' +
                                '</div>' +
                            '</div>' +
                        '</div>' +
                        '<div class="col-md-2 col-sm-2">' +
