                    ...
                    <div class="px-7 py-5">
                        ...
                        <div class="mb-10">
                            ...
                            <select class="form-select form-select-solid fw-bold" data-kt-select2="true" data-placeholder="Select option" data-allow-clear="true" data-kt-customer-table-filter="month" data-dropdown-parent="#kt-toolbar-filter-verify-type" name="account_verified_type">
                                <option></option>
                                <?php 
                                if( !empty($account_verified_status) ) {
                                    foreach($account_verified_status as $key=>$account_verified_type) { 
                                ?>
        ...
        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_staff_table">
            ...
            <thead>
                ...
                <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                    ...
                    <th class="min-w-125px"><?php echo $this->lang->line("heading_primary_email") ?></th>
                    <th class="min-w-125px"><?php echo $this->lang->line("heading_primary_phone_no") ?></th>
            ...
            <tbody class="fw-semibold text-gray-600">                
                ...
                <tr>
                    ...
                    <td><?php echo $record['orgnization_type'] ?></td>
