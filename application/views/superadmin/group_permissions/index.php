<?php $edit_permissions = hasPermission($this->user_data['group_id'],"{$controller_name}.edit",SUPERADMIN);?>
        ...
        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_records_table">
            ...
            <tbody class="fw-semibold text-gray-600">                
                ...
                <tr>
                    ...
                    <!--begin::Action=-->
                    <td class="text-end">
                        <?php if( $record["is_super_admin"]==IS_NOT_SUPERADMIN ) { ?>
                        ...
                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                            ...
                            /* if( hasPermission($this->user_data['group_id'],"{$controller_name}.delete",SUPERADMIN) ) {?>
                            <!--begin::Menu item-->
                            <div class="menu-item px-3">
