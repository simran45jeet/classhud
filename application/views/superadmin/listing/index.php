...
$listing_users_permission =  hasPermission($this->user_data['group_id'],"{$controller_name}.listing_users",SUPERADMIN) ;
$add_order_permission =  hasPermission($this->user_data['group_id'],"{$controller_name}.add_order",SUPERADMIN) ;
?>
                ...
                <tr>
                    ...
                    <td>
                        <div class="d-flex align-items-center">
                            ...
                            <div class="ms-5">
                                <!--begin::Title-->
                                <a href="<?php echo $edit_permission ? superadmin_url("{$controller_name}/edit/{$encoded_id}") : "#"; ?>" class="text-gray-800 text-hover-primary fs-5 fw-bold" data-kt-ecommerce-product-filter="listing_name"><?php echo stripcslashes($record["name"]) ?></a>
                                <!--end::Title-->
                            </div>
                        </div>
