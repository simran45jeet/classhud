                            ...
                            <div class="card-body pt-0 pb-5">
                                ...
                                <div class="row mb-5">
                                    <div class="col-md-6 fv-row">
                                        <!--begin::Label-->
                                        <label class="required fs-5 fw-semibold mb-2"><?php echo $this->lang->line('heading_banner_category_title') ?></label>
                                        <select name="banner_category" class="form-control form-select" data-control="select2" >
                                            <option value=""><?php echo $this->lang->line("heading_banner_category_title") ?></option>
                                            <?php foreach( $banner_categories as $key=>$banner_category ) {?>
                                            <option value="<?php echo encrypt($banner_category["id"]) ?>" <?php echo !empty($post_data["banner_category"]) && decrypt($post_data["banner_category"]) == $banner_category["id"] ? "selected=''":"" ?>><?php echo $banner_category["name"] ?></option>
                                            <?php } ?>
                                        </select>
                                        <span class="text-danger"><?php echo form_error("name") ?></span>
                                    </div>                                    
                                        ...
                                        <div class="card card-flush py-4">
                                            ...
                                            <div class="card-body text-left pt-0">
                                                ...
                                                <div class="image-input image-input-outline" data-kt-image-input="true">
                                                    ...
                                                    <div class="image-input-wrapper w-150px h-150px" style="background-image: url('<?php echo !empty($post_data["image"]) ? base_url(BASE_BANNER_IMAGES_PATH . $post_data["image"]) : "" ?>')"></div>
                                                    ...
                                                    <!--end::Label-->
                                                    <!--begin::Cancel-->
                                                    <span class="btn btn-icon btn-circle btn-active-color-primary w-25px h-25px bg-body shadow d-none" data-kt-image-input-action="cancel" data-bs-toggle="tooltip" title="Cancel avatar">
                                                        <i class="bi bi-x fs-2"></i>
                                                    </span>
                                                    <!--end::Cancel-->
                                                    <!--begin::Remove-->
                                                    <span class="btn btn-icon btn-circle btn-active-color-primary w-25px h-25px bg-body shadow d-none" data-kt-image-input-action="remove" data-bs-toggle="tooltip" title="<?php echo $this->lang->line("heading_remove") ?>">
                                                        <i class="bi bi-x fs-2"></i>
                                                    </span>
                                                    <!--end::Remove-->
                                                </div>
