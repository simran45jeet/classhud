        ...
        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_staff_table">
            ...
            <thead>
                ...
                <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                    ...
                    <th class="min-w-125px"><?php echo $this->lang->line("heading_claim_listing_user_name_title") ?></th>
                    <th class="min-w-125px"><?php echo $this->lang->line("heading_claim_listing_user_phone_title") ?></th>
                    <th class="min-w-125px"><?php echo $this->lang->line("heading_claim_institute_personal_document_title") ?></th>
                    <th class="min-w-125px"><?php echo $this->lang->line("heading_claim_institute_legal_document_title") ?></th>
                ...
                <tr>
                    ...
                    <td>
                        <div class="align-items-center">
                            <!--begin::Thumbnail-->
                            <a href="<?php echo base_url("best/".strtolower($record["listing_type_name"])."/{$record["slug"]}/".strtolower($record["city_name"])) ?>" class="symbol symbol-50px" target="_blank">
                    ...
                    <td>
                        <div class="d-flex align-items-center">
                            <a href="<?php echo $edit_permission ? superadmin_url("{$controller_name}/edit/{$encoded_id}") : "#"; ?>"" class="symbol symbol-50px">
                                <span class="symbol-label" style="background-image:url('<?php echo base_url(BASE_CLAIM_LISTING_PERSONAL_DOCUMENTS_IMAGE_PATH . "{$record["personal_document"]}") ?>');"></span>
                            </a>
                        </div>
                    </td>
                    <td>
                        <div class="d-flex align-items-center">
                            <a href="<?php echo $edit_permission ? superadmin_url("{$controller_name}/edit/{$encoded_id}") : "#"; ?>"" class="symbol symbol-50px">
                                <span class="symbol-label" style="background-image:url('<?php echo base_url(BASE_CLAIM_LISTING_LEGAL_DOCUMENTS_IMAGE_PATH . "{$record["legal_document"]}") ?>');"></span>
                            </a>
                        </div>
                    </td>
                    <td class="text-end">
