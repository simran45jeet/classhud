        ...
        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_staff_table">
            ...
            <thead>
                ...
                <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                    ...
                    <th><?php echo $this->lang->line("heading_order_total_amount_title") ?></th>
                    <th><?php echo $this->lang->line("heading_order_paid_amount_title") ?></th>
                    <th><?php echo $this->lang->line("heading_order_status_title") ?></th>
                    <th><?php echo $this->lang->line("heading_order_payment_status_title") ?></th>
                ...
                <tr>
                    ...
                    <td>
                        <div class="d-flex align-items-center">
                            ...
                            <div class="ms-5">
                                <!--begin::Title-->
                                <a href="<?php echo $edit_permission ? superadmin_url("{$controller_name}/edit/{$encoded_id}") : "#"; ?>" class="text-gray-800 text-hover-primary fs-5 fw-bold" data-kt-ecommerce-product-filter="listing_name"><?php echo $record["listing_name"] ?></a>
                                <!--end::Title-->
                            </div>
                        </div>
                        
                    </td>
                    <td><?php echo $record['listing_email'] ?></td>
                    <td><?php echo $record['listing_phone_no'] ?></td>
                    <td><?php echo number_format($record['total_amount'],2); ?></td>
                    <td><?php echo number_format($record['paid_amount'],2); ?></td>
                    <td><?php echo $this->lang->line("heading_order_status")[$record["order_status"]] ?></td>
                    <td><?php echo $this->lang->line("heading_payment_status")[$record["payment_status"]] ?></td>
                    <td class="text-end">
