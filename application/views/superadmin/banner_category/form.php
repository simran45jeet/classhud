                        ...
                        <div class="card pt-4 mb-6 mb-xl-9">
                            ...
                            <div class="card-body pt-0 pb-5">
                               ...
                               <div class="row mb-5">
                                    <div class="col-md-6 fv-row">
                                        <!--begin::Label-->
                                        <label class="required fs-5 fw-semibold mb-2"><?php echo $this->lang->line('heading_start_date_title') ?></label>
                                        <input type="text" class="form-control form-solid date_picker" name="start_date" value="<?php echo !empty($post_data["start_date"]) ? stripcslashes($post_data["start_date"]) : ""; ?>"/>
                                        <span class="text-danger"><?php echo form_error("start_date") ?></span>
                                    </div>
                                    <div class="col-md-6 fv-row">
                                        <!--begin::Label-->
                                        <label class="required fs-5 fw-semibold mb-2"><?php echo $this->lang->line("heading_end_date_title") ?></label>
                                        <input type="text" class="form-control form-solid date_picker" name="end_date" value="<?php echo !empty($post_data["end_date"]) ? stripcslashes($post_data["end_date"]) : ""; ?>"/>
